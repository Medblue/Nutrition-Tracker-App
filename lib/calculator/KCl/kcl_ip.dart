...
class KClCalcPage extends StatefulWidget {
  const KClCalcPage({super.key});

  @override
  State<KClCalcPage> createState() => _KClCalcPageState();
}

class _KClCalcPageState extends State<KClCalcPage> {
  // Defining variables
  double weight = 0;
  double K = 0;
  double ans = 0;
  ...
  void calcAns() {
    setState(() {
      ...
      ans = ((K * (weight / 1000)) * 0.5);
      overfill = (ans * 1.2);
      osmolality = (overfill * 4);
